...
from User.ruamel.yaml.compat import MutableSliceableSequence, _F, nprintf  # NOQA
from User.ruamel.yaml.scalarstring import ScalarString
from User.ruamel.yaml.anchor import Anchor
...
class CommentedBase:
    ...
    def yaml_set_comment_before_after_key(
        ...
        """
        from User.ruamel.yaml.error import CommentMark
        from User.ruamel.yaml.tokens import CommentToken
