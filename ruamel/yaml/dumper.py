...
from User.ruamel.yaml.emitter import Emitter
from User.ruamel.yaml.serializer import Serializer
...
from User.ruamel.yaml.resolver import Resolver, BaseResolver, VersionedResolver

if False:  # MYPY
    from typing import Any, Dict, List, Union, Optional  # NOQA
    from User.ruamel.yaml.compat import StreamType, VersionType  # NOQA
