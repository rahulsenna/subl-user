...
import sys
from User.ruamel.yaml.error import YAMLError, YAMLStreamError
from User.ruamel.yaml.events import *  # NOQA

# fmt: off
from User.ruamel.yaml.compat import _F, nprint, dbg, DBG_EVENT, \
    check_anchorname_char, nprintf  # NOQA
# fmt: on

if False:  # MYPY
    from typing import Any, Dict, List, Union, Text, Tuple, Optional  # NOQA
    from User.ruamel.yaml.compat import StreamType  # NOQA
