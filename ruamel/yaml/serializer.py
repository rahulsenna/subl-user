...
from User.ruamel.yaml.error import YAMLError
from User.ruamel.yaml.compat import nprint, DBG_NODE, dbg, nprintf  # NOQA
from User.ruamel.yaml.util import RegExp

from User.ruamel.yaml.events import (
    StreamStartEvent,
    StreamEndEvent,
    MappingStartEvent,
    MappingEndEvent,
...
from User.ruamel.yaml.nodes import MappingNode, ScalarNode, SequenceNode

if False:  # MYPY
    from typing import Any, Dict, Union, Text, Optional  # NOQA
    from User.ruamel.yaml.compat import VersionType  # NOQA
