...
from User.ruamel.yaml.error import YAMLError, FileMark, StringMark, YAMLStreamError
from User.ruamel.yaml.compat import _F  # NOQA
from User.ruamel.yaml.util import RegExp

if False:  # MYPY
    from typing import Any, Dict, Optional, List, Union, Text, Tuple, Optional  # NOQA
#    from User.ruamel.yaml.compat import StreamTextType  # NOQA
