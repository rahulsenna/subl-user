...
from User.ruamel.yaml.constructor import Constructor, BaseConstructor, SafeConstructor
from User.ruamel.yaml.representer import Representer, SafeRepresenter, BaseRepresenter
from User.ruamel.yaml.resolver import Resolver, BaseResolver

if False:  # MYPY
    from typing import Any, Union, Optional  # NOQA
    from User.ruamel.yaml.compat import StreamTextType, StreamType, VersionType  # NOQA
