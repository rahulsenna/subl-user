...
# fmt: off
from User.ruamel.yaml.error import (MarkedYAMLError, MarkedYAMLFutureWarning,
                               MantissaNoDotYAML1_1Warning)
from User.ruamel.yaml.nodes import *                               # NOQA
from User.ruamel.yaml.nodes import (SequenceNode, MappingNode, ScalarNode)
from User.ruamel.yaml.compat import (_F, builtins_module, # NOQA
                                nprint, nprintf, version_tnf)
from User.ruamel.yaml.compat import ordereddict  # type: ignore

from User.ruamel.yaml.comments import *                               # NOQA
from User.ruamel.yaml.comments import (CommentedMap, CommentedOrderedMap, CommentedSet,
                                  CommentedKeySeq, CommentedSeq, TaggedScalar,
                                  CommentedKeyMap,
                                  C_KEY_PRE, C_KEY_EOL, C_KEY_POST,
                                  C_VALUE_PRE, C_VALUE_EOL, C_VALUE_POST,
                                  )
from User.ruamel.yaml.scalarstring import (SingleQuotedScalarString, DoubleQuotedScalarString,
                                      LiteralScalarString, FoldedScalarString,
                                      PlainScalarString, ScalarString,)
from User.ruamel.yaml.scalarint import ScalarInt, BinaryInt, OctalInt, HexInt, HexCapsInt
from User.ruamel.yaml.scalarfloat import ScalarFloat
from User.ruamel.yaml.scalarbool import ScalarBoolean
from User.ruamel.yaml.timestamp import TimeStamp
from User.ruamel.yaml.util import RegExp
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_rt_sequence(self, node, seqtyp, deep=False):
        ...
        if node.anchor:
            from User.ruamel.yaml.serializer import templated_id
