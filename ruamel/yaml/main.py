...
import User.ruamel.yaml
from User.ruamel.yaml.error import UnsafeLoaderWarning, YAMLError  # NOQA

from User.ruamel.yaml.tokens import *  # NOQA
from User.ruamel.yaml.events import *  # NOQA
from User.ruamel.yaml.nodes import *  # NOQA

from User.ruamel.yaml.loader import BaseLoader, SafeLoader, Loader, RoundTripLoader  # NOQA
from User.ruamel.yaml.dumper import BaseDumper, SafeDumper, Dumper, RoundTripDumper  # NOQA
from User.ruamel.yaml.compat import StringIO, BytesIO, with_metaclass, nprint, nprintf  # NOQA
from User.ruamel.yaml.resolver import VersionedResolver, Resolver  # NOQA
from User.ruamel.yaml.representer import (
    BaseRepresenter,
    SafeRepresenter,
    Representer,
    RoundTripRepresenter,
)
from User.ruamel.yaml.constructor import (
    BaseConstructor,
    SafeConstructor,
    Constructor,
    RoundTripConstructor,
)
from User.ruamel.yaml.loader import Loader as UnsafeLoader
from User.ruamel.yaml.comments import CommentedMap, CommentedSeq, C_PRE

if False:  # MYPY
    from typing import List, Set, Dict, Union, Any, Callable, Optional, Text  # NOQA
    from User.ruamel.yaml.compat import StreamType, StreamTextType, VersionType  # NOQA
...
def warn_deprecation(fun, method, arg=''):
    ...
    from User.ruamel.yaml.compat import _F
