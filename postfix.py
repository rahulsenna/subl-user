...
DEFAULT_POSTFIXES_PATH = "Packages/User/Postfixer/postfixes.yml"
...
class ReloadPostfixesCommand(sublime_plugin.WindowCommand):
  ...
  def run(self):
    ...
    try:
      ...
      print("Cannot load default postfixes file: " + DEFAULT_POSTFIXES_PATH)
    ...
    try:
      ...
      print("Cannot parse postfixes yaml")
